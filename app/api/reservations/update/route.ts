...
export async function PUT(req: Request) {
  ...
  const { id, unit_id, meeting_room_id, date, start_time, end_time, participants_count, consumption_items, amount } = body;
  ...
  await supabase.from("reservation_consumptions").delete().eq("reservation_id", id);
